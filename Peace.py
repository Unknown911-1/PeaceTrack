...
╚╝──╚══╩╝╚╩══╩══╝───╚╝╚╝╚╝╚╩══╩╝╚╝
          ...
          \033[1;37m[ + ]  C O D E   B Y  U N K N O W N 9 1 1 - 1 [ + ]  
        
    \033[1;37m[ 1 ] \033[1;32mIP Tracker
    \033[1;37m[ 2 ] \033[1;32mShow Your IP
    \033[1;37m[ 3 ] \033[1;32mPhone Tracker
    \033[1;37m[ 4 ] \033[1;32mUsername Tracker
    \033[1;37m[ 0 ] \033[1;32mExit                
    """)


try:
    input_user = input(f'\n   {Wh}@Peace~# {Gr}')  # OPSI MENU

    if input_user == '1':  # OPSI 1
        # Rest of the code for Option 1...
        os.system('clear')
        time.sleep(1)
        print(f"""{Wh}
         .-.
       .'   `.          {Wh}--------------------------------
       :g g   :         {Wh}| {Gr}PEACE-- TRACKER - IP ADDRESS {Wh}|
       : o    `.        {Wh}|       {Gr}@CODE BY UNKNOWN911-1    {Wh}|
      :         ``.     {Wh}--------------------------------
     :             `.
    :  :         .   `.
    :   :          ` . `.
     `.. :            `. ``;
        ...
        # Rest of the code for Option 3...
        os.system('clear')
        time.sleep(1)
        print(f"""{Wh}
         .-.
       .'   `.          {Wh}----------------------------------
       :g g   :         {Wh}| {Gr}PEACE- TRACKER - PHONE NUMBER {Wh}|
       : o    `.        {Wh}|        {Gr}@CODE BY U N K N O W N 9 1 1 - 1      {Wh}|
      :         ``.     {Wh}----------------------------------
     :             `.
    :  :         .   `.
    :   :          ` . `.
     `.. :            `. ``;
        ...
        try:
            def phoneGW():
                User_phone = input(f"\n {Wh}[+]Enter phone number target {Gr}Ex [+1 (xxx) xxx-xxxx] {Wh}: {Gr}")  # INPUT NUMBER PHONE
                default_region = "global"  # Change the default region to "global"

                parsed_number = phonenumbers.parse(User_phone, default_region)  # VARIABLE PHONENUMBERS
                region_code = phonenumbers.region_code_for_number(parsed_number)
                jenis_provider = carrier.name_for_number(parsed_number, "en")
                location = geocoder.description_for_number(parsed_number, "en")  # Get location in English
        ...
        print(f"""{Wh}
         .-.
       .'   `.          {Wh}----------------------------------
       :g g   :         {Wh}|  {Gr}PEACE- SHOW YOUR IP ADDRESS  {Wh}|
       : o    `.        {Wh}|        {Gr}@CODE BY U N K N O W N 9 1 1 - 1      {Wh}|
      :         ``.     {Wh}----------------------------------
     :             `.
    :  :         .   `.
    :   :          ` . `.
     `.. :            `. ``;
        ...
        print(f"""{Wh}
         .-.
       .'   `.          {Wh}----------------------------------
       :g g   :         {Wh}|    {Gr}PEACE - TRACKER USERNAME    {Wh}|
       : o    `.        {Wh}|        {Gr}@CODE BY U  N K N O W N 9 1 1        {Wh}|
      :         ``.     {Wh}----------------------------------
     :             `.
    :  :         .   `.
    :   :          ` . `.
